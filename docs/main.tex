...
\begin{figure}
    ...
    \begin{tabular}{ccc}
        ...
        \subfloat{\includegraphics[width=4cm]{images/ej3/bestcase/08.png}}
    \end{tabular}
...
\begin{figure}
    ...
    \caption{Ejemplo de una corrida de peor caso para el ejercicio 3. El arreglo de arriba representa el vector interno de la cola de prioridad. \label{grf:ex3-worst}}
\end{figure}
